...
class TestOutsideTemperatureFromWeather:
    """Tests for outside temperature from weather entity."""

    def test_outside_temp_from_weather_entity(
        self, mock_hass: MagicMock, mock_logger: ConfigContextAdapter
    ) -> None:
        """Test outside_temperature is fetched from weather entity."""
        from custom_components.adaptive_cover.calculation import ClimateCoverData

        # Mock state_attr to return temperature from weather entity
        with patch(
            ...
            climate = ClimateCoverData(
                ...
                temp_high=25.0,
                presence_entity=None,
                weather_entity="weather.home",  # Weather entity set
                weather_condition=["sunny"],
                outside_entity=None,  # No outside entity
                temp_switch=False,
                blind_type="cover_blind",
                transparent_blind=False,
                lux_entity=None,
            ...
            assert climate.outside_temperature == 25.0
